...
class stock_picking(orm.Model):
    ...
    _columns = {
        'purchase_organization_id': fields.many2one(
            'purchase.organization', string='Purchase Organization'),
    }
    ...
    def _prepare_invoice(self, cr, uid, picking, partner, inv_type, journal_id,
        ...
        if picking.purchase_organization_id:
            invoice_vals['purchase_organization_id'] = \
                picking.purchase_organization_id.id
        return invoice_vals
...
class stock_picking_in(orm.Model):
    ...
    def __init__(self, pool, cr):
        ...
        self._columns['purchase_organization_id'] = \
            self.pool['stock.picking']._columns['purchase_organization_id']
