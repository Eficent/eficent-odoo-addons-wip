...
class purchase_organization(orm.Model):

    _name = 'purchase.organization'
    ...
    _sql_constraints = [
        ('code_company_uniq', 'unique (code,company_id)',
         'The code of the purchasing organization must '
         'be unique per company !'),
        ('name_company_uniq', 'unique (name,company_id)',
         'The name of the purchasing organization must '
         'be unique per company !')
    ]